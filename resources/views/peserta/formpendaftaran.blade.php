...
@section('contentMain')
    <div class="flex justify-center p-5 bg-white">
        <div
            ...
            <h1 class="text-start text-3xl font-bold mb-6">Pendaftaran Mahasiswa</h1>
            <form action="{{ route('updateDataPendaftaran') }}" method="POST" onsubmit="return validateForm()"
                ...
                <div class="flex flex-col gap-4 my-2">
                    ...
                    <div class="mb-4">
                        <label for="kewarganegaraan" class="block mb-2 text-sm font-medium text-gray-700">Pilih Kota</label>
                ...
                <button type="submit"
                    class="py-3 px-5 w-full text-base font-medium text-center text-white bg-gradient-to-br from-blue-500 to-blue-500 hover:scale-[1.02] shadow-md shadow-gray-300 transition-transform rounded-lg ">Update
                    Data
                </button>
            </form>
        </div>
